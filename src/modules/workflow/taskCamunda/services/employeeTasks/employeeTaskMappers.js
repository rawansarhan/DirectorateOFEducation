...
function mapUserStageToItem (row) {
  ...
  return {
    ...
    type_trans_id: processDefinition?.type_trans_id ?? typeTrans?.id ?? null,
    type_process_id: processDefinition?.type_trans_id ?? typeTrans?.id ?? null,
    process_definition_id: processDefinition?.id ?? processInstance?.process_definition_id ?? null,
