 ...
 *   get:
 *     summary: جلب البطاقة الذاتية المرتبطة بحساب موظف (إن وُجدت)
 *     description: |
 *       يبحث عن بطاقة ذاتية عبر `user_id` = معرّف الموظف.
 *       لإنشاء/بحث البطاقات المستقلة استخدم `/api/self-cards`.
 *     tags: [Employee]
 *     security:
 *       - bearerAuth: []
 *     parameters:
