...
const ERROR_CODE_STATUS = Object.freeze({
  ...
  SEALED_SNAPSHOT_TAMPERED: HTTP_STATUS.UNPROCESSABLE_ENTITY,
  INTEGRITY_CHAIN_FORGED: HTTP_STATUS.UNPROCESSABLE_ENTITY,
  SEALED_TEMPLATE_VALUES_MISSING: HTTP_STATUS.BAD_REQUEST,
  ...
  STAGE_SEALED: HTTP_STATUS.CONFLICT,
  SIGNING_DECISION_MISMATCH: HTTP_STATUS.BAD_REQUEST,
  SIGNING_SNAPSHOT_MISMATCH: HTTP_STATUS.BAD_REQUEST,
